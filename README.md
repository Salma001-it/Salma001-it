...
`Python` `PyTorch` `scikit-learn` `Java` `R` `SQL` `VBA`
Transformers · Diffusion Models · RAG · Reinforcement Learning (GRPO, Q-Learning) · Time-series econometrics (ARIMA/SARIMA)
